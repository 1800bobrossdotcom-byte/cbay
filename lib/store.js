...
const PRODUCTS = {
  spectra: {
    ...
    description: '13 real-time camera modes — night vision, thermal, edge detect, motion, text, halftone, pixel sort, VHS, databend, melt, kaleidoscope, posterize, and normal.',
    tags: ['night vision', 'thermal', 'motion', 'edge', 'text', 'halftone', 'pixel sort', 'VHS', 'databend', 'melt', 'kaleidoscope', 'posterize', 'normal'],
    type: 'app',
    access: 'freemium',
    webPath: '/spectra',
    tier: 'visual',
  ...
  'cbay-suite': {
    ...
    tags: ['spectra', 'take', 'synth', 'breaks', 'all'],
    type: 'bundle',
    access: 'paid',
    webPath: null,
    tier: 'visual',
  ...
  'audio-suite': {
    ...
    description: 'Unlock TONES + SHIELD + TONE LAB + SYNTH + BREAKS on iOS, Android, and Desktop with a single code.',
    tags: ['tones', 'shield', 'tone-lab', 'synth', 'breaks', 'all-platforms'],
    type: 'bundle',
    access: 'paid',
    webPath: null,
    tier: 'audio',
  ...
  synth: {
    id: 'synth',
    name: 'SYNTH',
    tagline: 'polyphonic synthesizer',
    description: '8-voice poly synth — 2 oscillators, sub, noise, filter + amp ADSR, LFO, unison, drive, chorus, delay, reverb, vocoder. MIDI + multitouch keyboard.',
    tags: ['oscillators', 'filter', 'ADSR', 'LFO', 'unison', 'drive', 'chorus', 'delay', 'reverb', 'vocoder', 'MIDI'],
    type: 'app',
    access: 'freemium',
    webPath: '/synth',
    tier: 'audio',
  ...
  breaks: {
    id: 'breaks',
    name: 'BREAKS',
    tagline: 'drum machine & sampler',
    description: '16-pad MPC-style drum machine — 16-step sequencer, 8 patterns, sample loading, note repeat, bit crush, drive, delay, reverb, compressor, tap tempo.',
    tags: ['drum machine', '16 pads', 'sequencer', 'sample loading', 'note repeat', 'bit crush', 'drive', 'delay', 'reverb'],
    type: 'app',
    access: 'freemium',
    webPath: '/breaks',
    tier: 'audio',
