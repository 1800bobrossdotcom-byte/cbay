...
const PRODUCTS = {
  spectra: {
    ...
    description: 'Night vision, thermal imaging, motion detection, edge detection, text mapping, halftone — 7 modes of real-time camera processing.',
    tags: ['night vision', 'thermal', 'motion', 'edge', 'text', 'halftone', 'normal'],
    type: 'app',
    access: 'freemium',
    webPath: '/spectra',
    tier: 'visual',
  ...
  artifact: {
    ...
    description: '12 real-time glitch modes — pixel sort, VHS, databend, signal modulation, melt, posterize, kaleidoscope, invert, halftone, ASDF sort, screen corrupt, and more. Touch + audio reactive.',
    tags: ['pixel sort', 'VHS', 'databend', 'signal', 'melt', 'posterize', 'kaleidoscope', 'invert', 'halftone', 'ASDF', 'screen', 'normal'],
    type: 'app',
    access: 'freemium',
    webPath: '/artifact',
    tier: 'visual',
